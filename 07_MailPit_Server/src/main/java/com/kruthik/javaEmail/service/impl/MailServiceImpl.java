...
public class MailServiceImpl implements MailService {
	...
	@Override
	public String sendwithAttachment(MailDTO mailDTO, MultipartFile attachment) {
		return sendEmailWithDynamicAttachment(mailDTO, attachment);
	}
	...
	private String sendEmailWithDynamicAttachment(MailDTO mailDTO, MultipartFile attachment) {
		try {
			MimeMessage message = mailSender.createMimeMessage();
			MimeMessageHelper messageHelper = new MimeMessageHelper(message, true);
			messageHelper.setFrom(senderEmail);
