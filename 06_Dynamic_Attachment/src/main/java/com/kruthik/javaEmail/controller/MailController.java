...
public class MailController {
	...
	public ResponseEntity<String> sendWithAttachment(@RequestPart MailDTO mailDTO, @RequestPart MultipartFile attachment) {
		String response = mailService.sendwithAttachment(mailDTO, attachment);
		return ResponseEntity.status(HttpStatus.OK).body(response);
	}
